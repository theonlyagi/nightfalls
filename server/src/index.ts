...
import { PROTOCOL_VERSION, SESSION_GRACE_MS, isMovePacket, isShootPacket, isReadyPacket, isBuildPacket, isUpgradePacket, isRemovePacket, isWeaponChoicePacket, isMutationChoicePacket } from './protocol.js';
